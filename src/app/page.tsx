        ...
        >
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }} className="w-full sm:w-auto">
              <Link
                href="/catalogo"
                className="flex items-center justify-center gap-2 bg-[var(--color-primary)] hover:bg-[var(--color-primary-light)] text-white font-bold px-6 py-3.5 sm:px-8 sm:py-4 rounded-xl transition-colors duration-300 text-base sm:text-lg shadow-md w-full"
              >
                Ver Catálogo
            ...
            <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }} className="w-full sm:w-auto">
              <a
                ...
                className="flex items-center justify-center gap-2 bg-white border-2 border-[var(--color-primary)] text-[var(--color-primary)] font-bold px-6 py-3.5 sm:px-8 sm:py-4 rounded-xl transition-colors duration-300 text-base sm:text-lg hover:bg-[var(--color-primary)]/5 w-full"
              >
