export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="whatsapp-float fixed bottom-6 right-6 z-50 bg-green-500 text-white p-4 rounded-full shadow-lg hover:scale-[1.15] active:scale-[0.92] transition-transform duration-200"
    >
